...
public abstract class ParkingSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static ParkingSystemWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(ParkingSystemWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<ParkingSystemDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<ParkingSystemDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<ParkingSystemDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<ParkingSystemDbContext, Task<T>> func)
    {
        T result;
