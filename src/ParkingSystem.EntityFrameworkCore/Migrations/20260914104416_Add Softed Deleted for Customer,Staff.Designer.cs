...
namespace ParkingSystem.Migrations
{
    ...
    [Migration("20260914104416_Add Softed Deleted for Customer,Staff")]
    partial class AddSoftedDeletedforCustomerStaff
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("ParkingSystem.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("ParkingSystem.Entities.Customer", b =>
                {
                    b.HasOne("ParkingSystem.Authorization.Users.User", null)
                        .WithOne()
                        .HasForeignKey("ParkingSystem.Entities.Customer", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("ParkingSystem.Entities.Payment", b =>
                {
                    b.HasOne("ParkingSystem.Entities.Subscription", "Subscription")
                        .WithMany("Payments")
